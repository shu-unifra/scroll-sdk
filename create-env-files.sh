...
get_service_configmap_variables() {
    ...
    case "$service_name" in
        balance-checker)
            echo "L1_RPC_ENDPOINT:SCROLL_L1_RPC L2_RPC_ENDPOINT:SCROLL_L2_RPC L1_COMMIT_SENDER_ADDR:L1_COMMIT_SENDER_ADDR L1_FINALIZE_SENDER_ADDR:L1_FINALIZE_SENDER_ADDR"
            ;;
        blockscout)
        ...
        gas-oracle)
            ...
            ;;
        l1-devnet)
            echo "CHAIN_ID_L1:CHAIN_ID L1_FULLNODE_RPC_ENDPOINT:L1_FULLNODE_RPC_ENDPOINT L1_SHADOWFORK_BLOCK_NUMBER:L1_SHADOWFORK_BLOCK_NUMBER"
            ;;
        l1-explorer)
        ...
        l2-rpc)
            ...
            ;;
        l2-sequencer)
            echo "CHAIN_ID_L2:CHAIN_ID L1_RPC_ENDPOINT:L2GETH_L1_ENDPOINT L2GETH_SIGNER_ADDRESS:L2GETH_SIGNER_ADDRESS L1_CONTRACT_DEPLOYMENT_BLOCK:L2GETH_L1_CONTRACT_DEPLOYMENT_BLOCK"
            ;;
        rollup-node)
            echo "L1_SCROLL_CHAIN_PROXY_ADDR:L1_SCROLL_CHAIN_PROXY_ADDR L1_RPC_ENDPOINT:L1_RPC_ENDPOINT L2_RPC_ENDPOINT:L2_RPC_ENDPOINT ROLLUP_NODE_DB_CONNECTION_STRING:DATABASE_URL"
            ;;
        *)
...
# TODO: this is a workaround, we should name correctly that file directly from the gen-config docker image
cp $CHART_DIR/.env.frontend $CHART_DIR/frontend-config
