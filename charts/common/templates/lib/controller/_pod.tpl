...
*/ -}}
{{- define "scroll.common.lib.controller.pod" -}}
...
initContainers:
    ...
    {{- range $index, $key := (keys .Values.initContainers | uniq | sortAlpha) }}
      ...
      {{- if $container.env -}}
        ...
        {{- $newEnv := fromYaml (include "scroll.common.lib.container.envVars" $) -}}
  ...
  {{- end }}
containers:
  {{- include "scroll.common.lib.controller.mainContainer" . | nindent 2 }}
  ...
  {{- end }}
  {{- with (include "scroll.common.lib.controller.volumes" . | trim) }}
volumes:
    {{- nindent 2 . }}
  {{- end }}
